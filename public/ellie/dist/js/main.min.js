...
function navigateToLogin() {
    window.location.href = '/src/components/Login.js'; // Update this to match your routing structure
}

function navigateToSignup() {
    window.location.href = '/src/components/Signup.js'; // Update this to match your routing structure
}
